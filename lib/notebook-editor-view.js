...
export default class NotebookEditorView extends React.Component {
    ...
    componentDidMount() {
        this.subscriptions.add(
            this.store.addStateChangeListener(this._onChange));
    }
            ...
            return (
                <div
                    ...
                    <header className="notebook-toolbar">
                        <button
                            className="btn icon inline-block-tight icon-plus add-cell"
                            onClick={this.addCell} ></button>
                        <div className='inline-block btn-group'>
                           <button
                               className='btn icon icon-playback-play'
                               onClick={this.runActiveCell} ></button>
                           <button
                               className='btn icon icon-primitive-square'
                               onClick={this.interruptKernel} ></button>
                       </div>
                    </header>
