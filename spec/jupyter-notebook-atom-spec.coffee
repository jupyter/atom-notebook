...
describe "JupyterNotebookAtom", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('jupyter-notebook-atom')

  describe "when the jupyter-notebook-atom:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'jupyter-notebook-atom:toggle'
        expect(jupyterNotebookAtomPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'jupyter-notebook-atom:toggle'
        expect(jupyterNotebookAtomElement).not.toBeVisible()
